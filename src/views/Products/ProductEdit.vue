  ...
  methods: {
    ...
    prefillData(_id) {
      ...
      this.available_variants = [
        { price:10, Color: 'red', Size: 'sm'},
        { price:20, Color: 'red', Size: 'md'},
        { price:30, Color: 'red', Size: 'lg'},
        { price:40, Color: 'blue', Size: 'sm'},
        { price:50, Color: 'blue', Size: 'md'},
        { price:60, Color: 'blue', Size: 'lg'},
        { price:70, Color: 'green', Size: 'sm'},
        { price:80, Color: 'green', Size: 'md'},
        { price:90, Color: 'green', Size: 'lg'},
      ];
